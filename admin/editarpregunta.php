...
if (isset($_GET['actualizar'])) {
    ...
    $opcion_d = htmlspecialchars($_GET['opcion_d']); // Opción D agregada
    $correcta = $_GET['correcta'];
    $dificultad = isset($_GET['dificultad']) ? $_GET['dificultad'] : ''; // Verificamos si se ha enviado dificultad
    $tiempo = isset($_GET['tiempo']) ? $_GET['tiempo'] : ''; // Verificamos si se ha enviado tiempo

    //Armamos el query para insertar en la tabla preguntas
    $query = "UPDATE preguntas SET tema='$id_tema', pregunta='$pregunta', opcion_a='$opcion_a', opcion_b='$opcion_b', opcion_c='$opcion_c', opcion_d='$opcion_d', correcta = '$correcta', dificultad = '$dificultad', tiempo = '$tiempo' WHERE id='$id_pregunta'";
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get">
                        ...
                        <div class="fila">
                            ...
                            <select name="dificultad" id="">
                                <option value="Facil" <?php if($pregunta['dificultad']=='Facil'){ echo "selected";}?>>Fácil</option>
                                <option value="Medio" <?php if($pregunta['dificultad']=='Medio'){ echo "selected";}?>>Medio</option>
                                <option value="Dificil" <?php if($pregunta['dificultad']=='Dificil'){ echo "selected";}?>>Difícil</option>
                            </select>
                        </div>
                        <div class="fila">
                            <label for="">Tiempo:</label>
                            <input type="text" name="tiempo" required value="<?php echo $pregunta['tiempo']?>">
                        </div>
                        <hr>
