...
if (isset($_GET['guardar'])) {
    ...
    $query = "INSERT INTO preguntas (id, tema, pregunta, opcion_a, opcion_b, opcion_c, opcion_d, correcta, dificultad, tiempo)
    VALUES (NULL, '$id_tema','$pregunta', '$opcion_a','$opcion_b','$opcion_c','$opcion_d','$correcta', '$dificultad', '$tiempo')";
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get">
                        ...
                        <div class="opcion">
                            ...
                            <select name="correcta" id="" class="correcta">
                                ...
                                <option value="D">D</option> <!-- Opción D agregada -->
                            </select>
                        </div>
                        <div class="fila">
